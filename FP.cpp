...
public:
	...
	void verify()
	{
		...
		cout << "Police verification completed.\n" << endl;
	}
};
			...
			case 5:
			{
				...
				if (nn == 1)
				{
					...
					while (pcount <= 5)
					{
						...
						cout << left << setw(20) << "baseFee" << "lateFee" << endl;
						cout << left << setw(2) << "Rs" << setw(3) << baseFee;
						cout << setw(15) << " ";
						...
						else
						{
							...
							cout << left << setw(20) << "Days Past Deadline" << "Total Fee" << endl;
							...
							cout << left << setw(20) << days - 1 << "Rs" << totalFee << endl;
						}
						break;
					}
				}
				...
				if (nn == 2)
				{
					...
					while (pcount <= 5)
					{
						...
						cout << left << setw(25) << "Base_Reenewal_Fee" << "LateFee" << endl;
						cout << left << setw(2) << "Rs" << setw(3) << baserFee;
						cout << setw(19) << " ";
						...
						else
						{
							...
							// Display days past deadline and corresponding fee
							cout << left << setw(20) << rdays - 1 << "Rs" << rtotalFee << endl;
						}
						break;
					}
				}
